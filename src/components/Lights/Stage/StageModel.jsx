...
Command: npx gltfjsx@6.1.11 .\\StageV2.glb
*/
...
export function StageModel(props) {
  const { nodes, materials } = useGLTF('/StageV2.glb')
  return (
    <group {...props} dispose={null}>
      <group position={[0, 5.15, 1.87]} scale={[10.08, 1, 1]}>
        <mesh geometry={nodes.Plane_1.geometry} material={materials['Black-Basic']} />
      ...
      <mesh geometry={nodes.Farm.geometry} material={materials.Farm} position={[0, 4.65, 5.14]} rotation={[-Math.PI, 0, 0]} scale={[-2.93, -0.02, -0.02]} castShadow />
      ...
      <group position={[-3.84, 0.1, 5.02]} scale={[0.26, 0.05, 0.29]}>
        <mesh geometry={nodes.Cube006_1.geometry} material={materials['Cloth.001']} castShadow receiveShadow/>
        <mesh geometry={nodes.Cube006_2.geometry} material={materials['Black-Basic']} castShadow receiveShadow/>
      </group>
      ...
      <group position={[-4.54, 0.29, 6.03]} scale={[0.26, 0.05, 0.29]}>
        <mesh geometry={nodes.Cube011_1.geometry} material={materials['Cloth.001']} castShadow receiveShadow/>
        <mesh geometry={nodes.Cube011_2.geometry} material={materials['Black-Basic']} castShadow receiveShadow/>
      </group>
      ...
      <mesh geometry={nodes.Cube005.geometry} material={materials['Black-Basic']} position={[0.01, 0.05, 6.55]} scale={[0.36, 0.33, 0.31]} castShadow receiveShadow/>
      <group position={[-4.54, 0.47, 7.03]} scale={[0.26, 0.05, 0.29]}>
        <mesh geometry={nodes.Cube013_1.geometry} material={materials['Cloth.001']} castShadow receiveShadow/>
        <mesh geometry={nodes.Cube013_2.geometry} material={materials['Black-Basic']} castShadow receiveShadow/>
      </group>
