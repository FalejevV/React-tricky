...
Command: npx gltfjsx@6.1.11 .\\StageV6.glb
*/
...
export function StageModel(props) {
  const { nodes, materials } = useGLTF('/StageV6.glb')
  return (
    <group {...props} dispose={null}>
      <group position={[0, 5.15, 1.87]} scale={[10.08, 1, 1]}>
        <mesh geometry={nodes.Plane_1.geometry} material={materials['Black-Basic']} castShadow receiveShadow/>
        <mesh geometry={nodes.Plane_2.geometry} material={materials.Wood} castShadow receiveShadow/>
      </group>
      <mesh geometry={nodes.Floor.geometry} material={materials.Floor} position={[0, -0.31, 2.84]} rotation={[-Math.PI, 0, -Math.PI]} scale={[-8.49, -0.17, -1]} castShadow receiveShadow/>
      ...
      <mesh geometry={nodes['Stage-floor'].geometry} material={materials['Stage-Floor']} position={[0, -1.02, 0.11]} scale={[6.24, 1, 1]} castShadow receiveShadow/>
      <mesh geometry={nodes.Cube.geometry} material={materials['Black-Basic']}  position={[0.01, -0.32, 4.54]} scale={[0.12, 0.33, 0.31]} castShadow receiveShadow/>
      ...
      <group position={[0.09, 3.38, -4.65]} scale={[1.25, 1, 1]}>
        <mesh geometry={nodes.Plane005_1.geometry} material={materials['Cloth.001']} castShadow receiveShadow/>
        <mesh geometry={nodes.Plane005_2.geometry} material={materials.White} castShadow receiveShadow/>
      </group>
      ...
      <mesh geometry={nodes.Plane001.geometry} material={materials['Cloth-1']} position={[4.22, 0.95, -0.52]} rotation={[Math.PI / 2, 0, 0]} castShadow receiveShadow/>
      <mesh geometry={nodes.Plane002.geometry} material={materials['Cloth-2']} position={[3.62, 0.95, -2.6]} rotation={[Math.PI / 2, 0, 0]}  castShadow receiveShadow/>
      <mesh geometry={nodes.Plane003.geometry} material={materials['Cloth-1']} position={[3.18, 0.95, -4.46]} rotation={[Math.PI / 2, 0, 0]} castShadow receiveShadow/>
      <mesh geometry={nodes.Plane004.geometry} material={materials['Cloth-1']} position={[-4.09, 3.79, -0.52]} rotation={[-Math.PI / 2, 0, Math.PI]} castShadow receiveShadow/>
      <mesh geometry={nodes.Plane005.geometry} material={materials['Cloth-2']} position={[-3.49, 3.79, -2.6]} rotation={[-Math.PI / 2, 0, Math.PI]} castShadow receiveShadow/>
      <mesh geometry={nodes.Plane006.geometry} material={materials['Cloth-1']} position={[-3.05, 3.79, -4.46]} rotation={[-Math.PI / 2, 0, Math.PI]} castShadow receiveShadow/>
    </group>
  )
}

useGLTF.preload('/StageV6.glb')
